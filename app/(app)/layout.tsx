...
export default function AppLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Mobile bottom nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-brand-card border-t border-brand-border px-1 py-2 flex justify-around items-center z-50">
        ...
        <a href="/games" className="flex flex-col items-center text-xs text-brand-muted hover:text-brand-green">
        ...
        <a href="/tournaments" className="flex flex-col items-center text-xs text-brand-muted hover:text-brand-green">
          <svg className="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>
          Groups
        </a>
      </nav>
    </div>
